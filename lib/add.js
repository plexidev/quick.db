...
module.exports = function(db, params, options) {
  ...
  if (params.ops.target) {
    ...
    else if (isNaN(oldValue)) throw new Error('Target is not a number. 1');
    ...
    if (isNaN(fetched.json)) throw new Error('Target is not a number. 2');
    params.data = fetched.json + params.data;
  }
